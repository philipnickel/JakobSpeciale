...
.. "exercise_gallery/exercise_c/compute_convergence.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_exercise_gallery_exercise_c_compute_convergence.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_exercise_gallery_exercise_c_compute_convergence.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 12-316
...
.. _sphx_glr_download_exercise_gallery_exercise_c_compute_convergence.py:
