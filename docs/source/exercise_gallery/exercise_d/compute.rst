...
.. "exercise_gallery/exercise_d/compute.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_exercise_gallery_exercise_d_compute.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_exercise_gallery_exercise_d_compute.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 62-247
...
.. _sphx_glr_download_exercise_gallery_exercise_d_compute.py:
